...
from my_qrdet._qrdet_helpers import _yolo_v8_results_to_dict, _prepare_input, BBOX_XYXY, CONFIDENCE
...
class QRDetector:
    ...
    def detect(self, image: np.ndarray|Image.Image|torch.Tensor|str, is_bgr: bool = False,
