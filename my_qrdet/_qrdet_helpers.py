...
from my_qrdet.output_qrdet_dict_keys import BBOX_XYXY, BBOX_XYXYN, POLYGON_XY, POLYGON_XYN,\
...
def _prepare_input(source: str | np.ndarray | Image.Image | torch.Tensor, is_bgr: bool = False) ->\
        str | np.ndarray|Image.Image | torch.Tensor:
    """
